...
class Ui_encoders(object):
    def setupUi(self, encoders):
        encoders.setObjectName(_fromUtf8("encoders"))
        ...
        self.encoders_frame.setObjectName(_fromUtf8("encoders_frame"))
        ...
        self.cfgEINMODE.setObjectName(_fromUtf8("cfgEINMODE"))
        ...
        self.cfgEINSENSE.setObjectName(_fromUtf8("cfgEINSENSE"))
        ...
        self.cfgEINNSTEP.setObjectName(_fromUtf8("cfgEINNSTEP"))
        ...
        self.cfgEINNTURN.setObjectName(_fromUtf8("cfgEINNTURN"))
        ...
        self.cfgEINAUXPOL.setObjectName(_fromUtf8("cfgEINAUXPOL"))
        ...
        self.cfgINPMODE.setObjectName(_fromUtf8("cfgINPMODE"))
        ...
        self.cfgINPSENSE.setObjectName(_fromUtf8("cfgINPSENSE"))
        ...
        self.cfgINPNSTEP.setObjectName(_fromUtf8("cfgINPNSTEP"))
        ...
        self.cfgINPNTURN.setObjectName(_fromUtf8("cfgINPNTURN"))
        ...
        self.cfgINPAUXPOL.setObjectName(_fromUtf8("cfgINPAUXPOL"))
        ...
        self.cfgABSSENSE.setObjectName(_fromUtf8("cfgABSSENSE"))
        ...
        self.cfgABSNSTEP.setObjectName(_fromUtf8("cfgABSNSTEP"))
        ...
        self.cfgABSNTURN.setObjectName(_fromUtf8("cfgABSNTURN"))
        ...
        self.cfgABSOFFSET.setObjectName(_fromUtf8("cfgABSOFFSET"))
        ...
        self.cfgSSIDBITS.setObjectName(_fromUtf8("cfgSSIDBITS"))
        ...
        self.cfgSSICODE.setObjectName(_fromUtf8("cfgSSICODE"))
        ...
        self.cfgSSICLOCK.setObjectName(_fromUtf8("cfgSSICLOCK"))
        ...
        self.cfgSSIDELAY.setObjectName(_fromUtf8("cfgSSIDELAY"))
        ...
        self.cfgSSISTATUS.setObjectName(_fromUtf8("cfgSSISTATUS"))
    ...
    def retranslateUi(self, encoders):
        encoders.setWindowTitle(_translate("encoders", "Dialog", None))
        self.groupBox.setTitle(_translate("encoders", "Encln (rear panel input)", None))
        self.label.setText(_translate("encoders", "mode", None))
        self.label_2.setText(_translate("encoders", "direction", None))
        self.label_3.setText(_translate("encoders", "resolution", None))
        self.label_5.setText(_translate("encoders", "steps in", None))
        self.label_6.setText(_translate("encoders", "turn(s)", None))
        self.label_4.setText(_translate("encoders", "Aux signal polarity", None))
        self.groupBox_2.setTitle(_translate("encoders", "InPos (front panel input)", None))
        self.label_10.setText(_translate("encoders", "mode", None))
        self.label_11.setText(_translate("encoders", "direction", None))
        self.label_7.setText(_translate("encoders", "resolution", None))
        self.label_8.setText(_translate("encoders", "steps in", None))
        self.label_9.setText(_translate("encoders", "turn(s)", None))
        self.label_12.setText(_translate("encoders", "Aux signal\n"
"polarity", None))
        self.groupBox_3.setTitle(_translate("encoders", "Absolute encoder (SSI)", None))
        self.label_17.setText(_translate("encoders", "direction", None))
        self.label_13.setText(_translate("encoders", "resolution", None))
        self.label_14.setText(_translate("encoders", "steps in", None))
        self.label_15.setText(_translate("encoders", "turn(s)", None))
        self.label_23.setText(_translate("encoders", "offset", None))
        self.label_22.setText(_translate("encoders", "SSI parameters", None))
        self.label_21.setText(_translate("encoders", "data length (bits)", None))
        self.label_16.setText(_translate("encoders", "data coding", None))
        self.label_18.setText(_translate("encoders", "clock frequency", None))
        self.label_19.setText(_translate("encoders", "sampling delay", None))
        self.label_20.setText(_translate("encoders", "control bit pattern", None))
