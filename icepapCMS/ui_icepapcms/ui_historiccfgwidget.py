...
class Ui_HistoricCfgWidget(object):
    def setupUi(self, HistoricCfgWidget):
        ...
        self.label_3.setPixmap(QtGui.QPixmap(":/small_icons/icons/redpixel.png"))
        ...
        icon = QtGui.QIcon()
        icon.addFile(":/small_icons/small_icons/go-relative2.png")
        ...
        icon1 = QtGui.QIcon()
        icon1.addFile(":/small_icons/small_icons/save.png")
        ...
        icon2 = QtGui.QIcon()
        icon2.addFile(":/small_icons/small_icons/process-stop.png")
