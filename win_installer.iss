...
Source: "C:\Documents and Settings\gcuni\Desktop\svn\IcepapCMS\src\dist\icepapcms.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Documents and Settings\gcuni\Desktop\svn\IcepapCMS\src\dist\library.zip" ; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Documents and Settings\gcuni\Desktop\svn\IcepapCMS\src\dist\MSVCR71.dll" ; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Documents and Settings\gcuni\Desktop\svn\IcepapCMS\src\dist\pyexpat.pyd" ; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Documents and Settings\gcuni\Desktop\svn\IcepapCMS\src\dist\PyQt4._qt.pyd" ; DestDir: "{app}"; Flags: ignoreversion
...
Source: "C:\Documents and Settings\gcuni\Desktop\svn\IcepapCMS\src\dist\sip.pyd" ; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Documents and Settings\gcuni\Desktop\svn\IcepapCMS\src\dist\sqlite3.dll" ; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Documents and Settings\gcuni\Desktop\svn\IcepapCMS\src\dist\unicodedata.pyd" ; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Documents and Settings\gcuni\Desktop\svn\IcepapCMS\src\dist\w9xpopen.exe" ; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Documents and Settings\gcuni\Desktop\svn\IcepapCMS\src\dist\win32event.pyd" ; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Documents and Settings\gcuni\Desktop\svn\IcepapCMS\src\dist\win32file.pyd" ; DestDir: "{app}"; Flags: ignoreversion

; EXTRA DLLs needed to run the application in a clean winXP installation.
Source: "C:\Documents and Settings\gcuni\Desktop\svn\IcepapCMS\src\dist\extra-DLLS\msvcp71.dll" ; DestDir: "{app}"; Flags: ignoreversion

Source: "C:\Documents and Settings\gcuni\Desktop\svn\IcepapCMS\src\dist\db\*"; DestDir: "{app}\db"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "C:\Documents and Settings\gcuni\Desktop\svn\IcepapCMS\src\dist\doc\*"; DestDir: "{app}\doc"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "C:\Documents and Settings\gcuni\Desktop\svn\IcepapCMS\src\dist\templates\*"; DestDir: "{app}\templates"; Flags: ignoreversion recursesubdirs createallsubdirs
