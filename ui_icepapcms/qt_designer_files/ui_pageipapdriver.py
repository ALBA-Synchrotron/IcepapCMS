...
#
# Created: Fri Aug 31 17:16:53 2007
...
class Ui_PageiPapDriver(object):
    def setupUi(self, PageiPapDriver):
        ...
        self.gridlayout1.addWidget(self.txtDriverName,2,1,1,1)

        spacerItem = QtGui.QSpacerItem(240,16,QtGui.QSizePolicy.Expanding,QtGui.QSizePolicy.Minimum)
        ...
        self.gridlayout1.addWidget(self.txtDescription,0,0,1,3)
        ...
        self.gridlayout2.addItem(spacerItem1,4,3,1,1)

        self.groupBox_6 = QtGui.QGroupBox(self.tab_2)
        self.groupBox_6.setFlat(True)
        self.groupBox_6.setObjectName("groupBox_6")

        self.gridlayout3 = QtGui.QGridLayout(self.groupBox_6)
        ...
        self.gridlayout4.addWidget(self.IREGP,0,1,1,1)
        ...
        self.gridlayout4.addWidget(self.IREGI,1,1,1,1)
        ...
        self.gridlayout4.addWidget(self.label_23,0,0,1,1)
        self.gridlayout3.addWidget(self.groupBox_7,0,3,3,1)
        ...
        self.gridlayout3.addItem(spacerItem2,1,2,1,1)
        self.gridlayout2.addWidget(self.groupBox_6,1,0,1,2)

        spacerItem3 = QtGui.QSpacerItem(151,20,QtGui.QSizePolicy.Expanding,QtGui.QSizePolicy.Minimum)
        self.gridlayout2.addItem(spacerItem3,0,1,1,2)

        spacerItem4 = QtGui.QSpacerItem(181,20,QtGui.QSizePolicy.Expanding,QtGui.QSizePolicy.Minimum)
        self.gridlayout2.addItem(spacerItem4,2,1,1,3)
        ...
        self.gridlayout2.addWidget(self.frame_2,4,0,1,3)

        self.groupBox_9 = QtGui.QGroupBox(self.tab_2)
        self.groupBox_9.setFlat(True)
        self.groupBox_9.setObjectName("groupBox_9")

        self.gridlayout5 = QtGui.QGridLayout(self.groupBox_9)
        ...
        self.gridlayout5.addWidget(self.SD,0,1,1,1)

        self.label_19 = QtGui.QLabel(self.groupBox_9)
        self.label_19.setObjectName("label_19")
        self.gridlayout5.addWidget(self.label_19,0,0,1,1)
        ...
        self.gridlayout6.addWidget(self.TDIR,2,0,1,1)

        self.PSW = QtGui.QCheckBox(self.groupBox_8)
        self.PSW.setObjectName("PSW")
        self.gridlayout6.addWidget(self.PSW,1,0,1,1)

        self.ESW = QtGui.QCheckBox(self.groupBox_8)
        self.ESW.setObjectName("ESW")
        self.gridlayout6.addWidget(self.ESW,0,0,1,1)
        self.gridlayout2.addWidget(self.groupBox_8,2,0,1,1)

        spacerItem6 = QtGui.QSpacerItem(40,20,QtGui.QSizePolicy.Expanding,QtGui.QSizePolicy.Minimum)
        self.gridlayout2.addItem(spacerItem6,1,2,1,2)

        spacerItem7 = QtGui.QSpacerItem(20,40,QtGui.QSizePolicy.Minimum,QtGui.QSizePolicy.Expanding)
        self.gridlayout2.addItem(spacerItem7,5,1,1,1)

        self.line_2 = QtGui.QFrame(self.tab_2)
        self.line_2.setFrameShape(QtGui.QFrame.HLine)
        self.line_2.setFrameShadow(QtGui.QFrame.Sunken)
        self.line_2.setObjectName("line_2")
        self.gridlayout2.addWidget(self.line_2,3,0,1,1)
        ...
        self.gridlayout7 = QtGui.QGridLayout(self.inOut_widget)
        ...
        self.gridlayout8.addWidget(self.label_12,0,1,1,1)
        ...
        self.gridlayout8.addWidget(self.label_10,0,3,1,1)
        self.gridlayout7.addWidget(self.groupBox_3,3,0,1,3)
        ...
        self.gridlayout9.addWidget(self.label_14,0,1,1,1)

        self.cbAuxPos1Src = QtGui.QComboBox(self.groupBox_4)
        self.cbAuxPos1Src.setObjectName("cbAuxPos1Src")
        self.gridlayout9.addWidget(self.cbAuxPos1Src,2,1,1,1)

        self.cbAuxPos2Src = QtGui.QComboBox(self.groupBox_4)
        self.cbAuxPos2Src.setObjectName("cbAuxPos2Src")
        self.gridlayout9.addWidget(self.cbAuxPos2Src,3,1,1,1)
        self.gridlayout7.addWidget(self.groupBox_4,2,2,1,1)
        ...
        self.gridlayout7.addWidget(self.label_15,0,0,1,1)

        spacerItem8 = QtGui.QSpacerItem(121,20,QtGui.QSizePolicy.Expanding,QtGui.QSizePolicy.Minimum)
        self.gridlayout7.addItem(spacerItem8,1,1,1,1)
        ...
        self.gridlayout10.addWidget(self.label_8,0,3,1,1)
        ...
        self.gridlayout10.addWidget(self.label_7,0,2,1,1)
        ...
        self.gridlayout7.addWidget(self.listPredefined,1,0,1,1)
        ...
        self.gridlayout7.addWidget(self.btnClear,0,1,1,1)
        ...
        self.gridlayout11.addWidget(self.chbSyncAuxIn,6,0,1,1)

        self.cbSyncAuxInPol = QtGui.QComboBox(self.groupBox_5)
        self.cbSyncAuxInPol.setObjectName("cbSyncAuxInPol")
        self.gridlayout11.addWidget(self.cbSyncAuxInPol,6,1,1,1)
        ...
        self.gridlayout13.addItem(spacerItem9,0,2,1,1)

        spacerItem10 = QtGui.QSpacerItem(40,20,QtGui.QSizePolicy.Expanding,QtGui.QSizePolicy.Minimum)
        self.gridlayout13.addItem(spacerItem10,0,0,1,1)
        ...
        self.historicWidget = HistoricCfgWidget(self.frame_right)
        self.historicWidget.setObjectName("historicWidget")
        self.vboxlayout.addWidget(self.historicWidget)
