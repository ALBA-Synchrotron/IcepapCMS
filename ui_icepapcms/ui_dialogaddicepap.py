...
#
# Created: Tue Sep 26 18:02:01 2006
...
class Ui_DialogAddIcepap(object):
    ...
    def tr(self, string):
        return QtGui.QApplication.translate("DialogAddIcepap", string, None, QtGui.QApplication.UnicodeUTF8)

    def retranslateUi(self, DialogAddIcepap):
        DialogAddIcepap.setWindowTitle(self.tr("Add Icepap System"))
        self.okButton.setText(self.tr("OK"))
        self.cancelButton.setText(self.tr("Cancel"))
        self.label_4.setText(self.tr("Description"))
        self.label_2.setText(self.tr("Host"))
        self.label_1.setText(self.tr("Port"))
