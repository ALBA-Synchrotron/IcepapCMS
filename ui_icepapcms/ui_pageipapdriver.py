...
class Ui_PageiPapDriver(object):
    def setupUi(self, PageiPapDriver):
        ...
        PageiPapDriver.resize(QtCore.QSize(QtCore.QRect(0,0,665,604).size()).expandedTo(PageiPapDriver.minimumSizeHint()))
        ...
        self.hboxlayout = QtGui.QHBoxLayout(self.pageTest)
        ...
        self.frame_test.setMinimumSize(QtCore.QSize(220,319))
        ...
        self.gridlayout1 = QtGui.QGridLayout(self.frame_test)
        ...
        self.gridlayout1.addWidget(self.btnGO,7,6,1,1)
        ...
        self.gridlayout2 = QtGui.QGridLayout(self.frame_leds)
        ...
        self.gridlayout2.addWidget(self.textLabel1_6_4,1,1,1,1)
        ...
        self.gridlayout2.addWidget(self.LedLimitPos,0,3,1,1)
        ...
        self.gridlayout2.addWidget(self.textLabel1_6_5,1,0,1,1)
        ...
        self.gridlayout2.addWidget(self.LedHome,0,2,1,1)
        ...
        self.gridlayout2.addWidget(self.textLabel1_6_3,1,2,1,1)
        ...
        self.gridlayout2.addWidget(self.textLabel1_6,1,3,1,1)
        ...
        self.gridlayout2.addWidget(self.LedStep,0,1,1,1)
        ...
        self.gridlayout2.addWidget(self.textLabel1_6_2,1,4,1,1)
        ...
        self.gridlayout2.addWidget(self.LedLimitNeg,0,4,1,1)
        ...
        self.gridlayout2.addWidget(self.LedError,0,0,1,1)
        ...
        self.gridlayout1.addWidget(self.frame_4,5,0,1,7)
        ...
        self.gridlayout1.addWidget(self.textLabel1_3_3_2,2,0,1,5)
        ...
        self.gridlayout1.addWidget(self.txtAcceleration,2,5,1,2)
        ...
        self.gridlayout1.addWidget(self.textLabel3,6,0,1,1)
        ...
        self.gridlayout1.addWidget(self.btnStopMotor,8,1,1,2)
        ...
        self.gridlayout1.addWidget(self.txtMvAbsolute,7,4,1,2)
        ...
        self.gridlayout1.addWidget(self.sbFactor,0,5,1,2)
        ...
        self.gridlayout1.addWidget(self.textLabel1_3_3,1,0,1,5)

        self.frame = QtGui.QFrame(self.frame_test)
        self.frame.setFrameShape(QtGui.QFrame.HLine)
        self.frame.setFrameShadow(QtGui.QFrame.Raised)
        self.frame.setObjectName("frame")
        self.gridlayout1.addWidget(self.frame,4,0,1,7)
        ...
        self.gridlayout1.addWidget(self.LCDPosition,6,1,1,6)
        ...
        self.gridlayout1.addWidget(self.sbPosition,3,5,1,2)
        ...
        self.gridlayout1.addWidget(self.textLabel1_3_4,3,0,1,2)
        ...
        self.gridlayout1.addWidget(self.textLabel1_3_3_2_2,0,0,1,5)
        ...
        self.gridlayout1.addWidget(self.txtSpeed,1,5,1,2)
        ...
        self.gridlayout1.addWidget(self.BtnSetPos,3,3,1,2)
        ...
        self.gridlayout1.addWidget(self.btnEnable,8,0,1,1)
        ...
        self.gridlayout1.addWidget(self.btnGORelativePos,8,6,1,1)
        ...
        self.gridlayout1.addWidget(self.btnGORelativeNeg,8,3,1,1)
        ...
        self.gridlayout1.addWidget(self.textLabel1_3,7,0,1,4)
        ...
        self.gridlayout1.addWidget(self.txtGORelative,8,4,1,2)
        ...
        self.gridlayout1.addWidget(self.groupBox,9,0,1,7)
        self.hboxlayout.addWidget(self.frame_test)
        ...
        self.gridlayout3.addItem(spacerItem4,4,3,1,1)
        ...
        self.gridlayout5 = QtGui.QGridLayout(self.groupBox_7)
        ...
        self.gridlayout5.addWidget(self.IREGP,0,1,1,1)
        ...
        self.gridlayout5.addWidget(self.IREGI,1,1,1,1)
        ...
        self.gridlayout5.addWidget(self.label_23,0,0,1,1)
        self.gridlayout4.addWidget(self.groupBox_7,0,3,3,1)

        self.label_18 = QtGui.QLabel(self.groupBox_6)
        self.label_18.setObjectName("label_18")
        self.gridlayout4.addWidget(self.label_18,1,0,1,1)

        spacerItem5 = QtGui.QSpacerItem(40,20,QtGui.QSizePolicy.Expanding,QtGui.QSizePolicy.Minimum)
        self.gridlayout4.addItem(spacerItem5,1,2,1,1)
        self.gridlayout3.addWidget(self.groupBox_6,1,0,1,2)

        spacerItem6 = QtGui.QSpacerItem(151,20,QtGui.QSizePolicy.Expanding,QtGui.QSizePolicy.Minimum)
        self.gridlayout3.addItem(spacerItem6,0,1,1,2)

        spacerItem7 = QtGui.QSpacerItem(181,20,QtGui.QSizePolicy.Expanding,QtGui.QSizePolicy.Minimum)
        self.gridlayout3.addItem(spacerItem7,2,1,1,3)
        ...
        self.hboxlayout4.addWidget(self.AUXPS)
        self.gridlayout3.addWidget(self.frame_2,4,0,1,3)

        self.groupBox_9 = QtGui.QGroupBox(self.tab_2)
        self.groupBox_9.setFlat(True)
        self.groupBox_9.setObjectName("groupBox_9")

        self.gridlayout6 = QtGui.QGridLayout(self.groupBox_9)
        ...
        self.gridlayout6.addWidget(self.SD,0,1,1,1)

        self.label_19 = QtGui.QLabel(self.groupBox_9)
        self.label_19.setObjectName("label_19")
        self.gridlayout6.addWidget(self.label_19,0,0,1,1)
        ...
        self.gridlayout6.addWidget(self.SDMAX,1,1,1,1)

        self.label_20 = QtGui.QLabel(self.groupBox_9)
        self.label_20.setObjectName("label_20")
        self.gridlayout6.addWidget(self.label_20,1,0,1,1)
        self.gridlayout3.addWidget(self.groupBox_9,0,0,1,1)

        self.groupBox_8 = QtGui.QGroupBox(self.tab_2)
        self.groupBox_8.setFlat(True)
        self.groupBox_8.setObjectName("groupBox_8")

        self.gridlayout7 = QtGui.QGridLayout(self.groupBox_8)
        ...
        self.gridlayout7.addWidget(self.TDIR,2,0,1,1)

        self.PSW = QtGui.QCheckBox(self.groupBox_8)
        self.PSW.setObjectName("PSW")
        self.gridlayout7.addWidget(self.PSW,1,0,1,1)

        self.ESW = QtGui.QCheckBox(self.groupBox_8)
        self.ESW.setObjectName("ESW")
        self.gridlayout7.addWidget(self.ESW,0,0,1,1)
        self.gridlayout3.addWidget(self.groupBox_8,2,0,1,1)

        spacerItem9 = QtGui.QSpacerItem(40,20,QtGui.QSizePolicy.Expanding,QtGui.QSizePolicy.Minimum)
        self.gridlayout3.addItem(spacerItem9,1,2,1,2)

        spacerItem10 = QtGui.QSpacerItem(20,40,QtGui.QSizePolicy.Minimum,QtGui.QSizePolicy.Expanding)
        self.gridlayout3.addItem(spacerItem10,5,1,1,1)

        self.line_2 = QtGui.QFrame(self.tab_2)
        self.line_2.setFrameShape(QtGui.QFrame.HLine)
        self.line_2.setFrameShadow(QtGui.QFrame.Sunken)
        self.line_2.setObjectName("line_2")
        self.gridlayout3.addWidget(self.line_2,3,0,1,1)
        ...
        self.gridlayout8 = QtGui.QGridLayout(self.inOut_widget)
        self.gridlayout8.setMargin(2)
        self.gridlayout8.setSpacing(2)
        ...
        self.gridlayout9.addWidget(self.label_12,0,1,1,1)
        ...
        self.gridlayout9.addWidget(self.label_11,0,2,1,1)
        ...
        self.gridlayout9.addWidget(self.label_10,0,3,1,1)
        self.gridlayout8.addWidget(self.groupBox_3,3,0,1,3)
        ...
        self.gridlayout10.addWidget(self.label_14,0,1,1,1)

        self.cbAuxPos1Src = QtGui.QComboBox(self.groupBox_4)
        self.cbAuxPos1Src.setObjectName("cbAuxPos1Src")
        self.gridlayout10.addWidget(self.cbAuxPos1Src,2,1,1,1)

        self.cbAuxPos2Src = QtGui.QComboBox(self.groupBox_4)
        self.cbAuxPos2Src.setObjectName("cbAuxPos2Src")
        self.gridlayout10.addWidget(self.cbAuxPos2Src,3,1,1,1)
        self.gridlayout8.addWidget(self.groupBox_4,2,2,1,1)
        ...
        self.gridlayout8.addWidget(self.label_15,0,0,1,1)

        spacerItem11 = QtGui.QSpacerItem(121,20,QtGui.QSizePolicy.Expanding,QtGui.QSizePolicy.Minimum)
        self.gridlayout8.addItem(spacerItem11,1,1,1,1)
        ...
        self.gridlayout11.addWidget(self.label_8,0,3,1,1)
        ...
        self.gridlayout11.addWidget(self.label_7,0,2,1,1)
        ...
        self.gridlayout8.addWidget(self.listPredefined,1,0,1,1)
        ...
        self.gridlayout8.addWidget(self.btnClear,0,1,1,1)
        ...
        self.hboxlayout6 = QtGui.QHBoxLayout(self.aux_widget)
        ...
        self.gridlayout12 = QtGui.QGridLayout(self.groupBox_5)
        ...
        self.gridlayout12.addWidget(self.chbSyncAuxIn,6,0,1,1)

        self.cbSyncAuxInPol = QtGui.QComboBox(self.groupBox_5)
        self.cbSyncAuxInPol.setObjectName("cbSyncAuxInPol")
        self.gridlayout12.addWidget(self.cbSyncAuxInPol,6,1,1,1)
        ...
        self.gridlayout13 = QtGui.QGridLayout(self.groupBox_10)
        ...
        self.gridlayout13.addWidget(self.label_26,0,2,1,1)
        ...
        self.gridlayout13.addWidget(self.label_27,0,1,1,1)
        self.hboxlayout6.addWidget(self.groupBox_10)
        ...
        self.gridlayout14 = QtGui.QGridLayout(self.labels_widget)
        self.gridlayout14.setMargin(2)
        self.gridlayout14.setSpacing(2)
        ...
        self.gridlayout14.addWidget(self.label_5,1,1,1,1)

        self.label_4 = QtGui.QLabel(self.labels_widget)
        self.label_4.setPixmap(QtGui.QPixmap(":/images/IcepapCfg Icons/axis.png"))
        self.label_4.setObjectName("label_4")
        self.gridlayout14.addWidget(self.label_4,0,1,1,1)

        spacerItem12 = QtGui.QSpacerItem(40,20,QtGui.QSizePolicy.Expanding,QtGui.QSizePolicy.Minimum)
        self.gridlayout14.addItem(spacerItem12,0,2,1,1)

        spacerItem13 = QtGui.QSpacerItem(40,20,QtGui.QSizePolicy.Expanding,QtGui.QSizePolicy.Minimum)
        self.gridlayout14.addItem(spacerItem13,0,0,1,1)
        self.tabSignals.addTab(self.tab_connectors,"")
        self.hboxlayout5.addWidget(self.tabSignals)
        ...
        self.gridlayout15 = QtGui.QGridLayout(self.frame_3)
        ...
        self.gridlayout15.addWidget(self.label_2,2,0,1,1)
        ...
        self.gridlayout15.addWidget(self.txtDriverName,2,1,1,1)

        spacerItem14 = QtGui.QSpacerItem(240,16,QtGui.QSizePolicy.Expanding,QtGui.QSizePolicy.Minimum)
        self.gridlayout15.addItem(spacerItem14,2,2,1,1)

        self.line = QtGui.QFrame(self.frame_3)
        self.line.setFrameShape(QtGui.QFrame.HLine)
        self.line.setFrameShadow(QtGui.QFrame.Sunken)
        self.line.setObjectName("line")
        self.gridlayout15.addWidget(self.line,1,0,1,3)
        ...
        self.gridlayout15.addWidget(self.txtDescription,0,0,1,3)
