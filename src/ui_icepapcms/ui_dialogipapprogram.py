...
#
# Created: Thu Jan 20 10:55:47 2011
...
class Ui_DialogIcepapProgram(object):
    def setupUi(self, DialogIcepapProgram):
        ...
        icon = QtGui.QIcon()
        icon.addFile(":/icons/IcepapCfg Icons/gnome-cpu.png")
        ...
        self.cbProgram.addItem(QtCore.QString())
        self.cbProgram.addItem(QtCore.QString())
        self.cbProgram.addItem(QtCore.QString())
        self.cbProgram.addItem(QtCore.QString())
        self.cbProgram.addItem(QtCore.QString())
        ...
        icon1 = QtGui.QIcon()
        icon1.addFile(":/icons/IcepapCfg Icons/close.png")
        ...
        icon2 = QtGui.QIcon()
        icon2.addFile(":/icons/IcepapCfg Icons/gnome-nettool.png")
        ...
        self.cbOptions.addItem(QtCore.QString())
        self.cbOptions.addItem(QtCore.QString())
        self.cbOptions.addItem(QtCore.QString())
    ...
    def retranslateUi(self, DialogIcepapProgram):
        ...
        self.cbProgram.setItemText(0, QtGui.QApplication.translate("DialogIcepapProgram", "NONE", None, QtGui.QApplication.UnicodeUTF8))
        self.cbProgram.setItemText(1, QtGui.QApplication.translate("DialogIcepapProgram", "ALL", None, QtGui.QApplication.UnicodeUTF8))
        self.cbProgram.setItemText(2, QtGui.QApplication.translate("DialogIcepapProgram", "DRIVERS", None, QtGui.QApplication.UnicodeUTF8))
        self.cbProgram.setItemText(3, QtGui.QApplication.translate("DialogIcepapProgram", "COMM", None, QtGui.QApplication.UnicodeUTF8))
        self.cbProgram.setItemText(4, QtGui.QApplication.translate("DialogIcepapProgram", "ADDR", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.cbOptions.setItemText(0, QtGui.QApplication.translate("DialogIcepapProgram", "SAVE", None, QtGui.QApplication.UnicodeUTF8))
        self.cbOptions.setItemText(1, QtGui.QApplication.translate("DialogIcepapProgram", "SL", None, QtGui.QApplication.UnicodeUTF8))
        self.cbOptions.setItemText(2, QtGui.QApplication.translate("DialogIcepapProgram", "NONE", None, QtGui.QApplication.UnicodeUTF8))
