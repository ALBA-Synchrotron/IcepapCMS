...
setup(name = "icepapms",
      ...
      packages = ["storm", "lib_icepapcms", "ui_icepapcms", "lib_icepapcms.pyIcePAP", "lib_icepapcms.pyIcePAP.serial","ui_icepapcms.icepapdriver_widget", "ui_icepapcms.Led"],
      data_files = [('doc', glob.glob("doc/*.*")),
                    ('db', glob.glob("doc/*.sql")),
